...
import { requireAuthentication, logAction, validateProductExists, requireOrganizationPermission } from '../../helpers';
...
export const deleteProductHandler = async (
  ...
  // Log the action
  await logAction(ctx, 'delete_product', 'DATA_CHANGE', 'HIGH', `Deleted product: ${product.title}`, currentUser._id, product.organizationId, {
