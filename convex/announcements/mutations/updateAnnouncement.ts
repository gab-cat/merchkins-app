...
import { requireAuthentication, requireOrganizationPermission, sanitizeString, logAction } from '../../helpers';

export const updateAnnouncementArgs = {
  announcementId: v.id('announcements'),
  title: v.optional(v.string()),
  content: v.optional(v.string()),
  contentType: v.optional(v.union(v.literal('TEXT'), v.literal('MARKDOWN'), v.literal('HTML'))),
