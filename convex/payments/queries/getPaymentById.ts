...
export const getPaymentByIdHandler = async (ctx: QueryCtx, args: { paymentId: Id<'payments'> }) => {
  ...
  } else if (currentUser._id !== payment.userId && !currentUser.isStaff && !currentUser.isAdmin) {
