  ...
  return (
    <div className="container mx-auto px-4 py-24" role="alert">
      <div className="mx-auto max-w-xl rounded-lg border bg-card p-8 text-center shadow-sm">
        ...
        <div className="mt-6">
          <button className="inline-flex h-10 items-center justify-center rounded-md border bg-background px-4 text-sm font-medium shadow-sm hover:bg-accent" onClick={() => reset()}>Try again</button>
        </div>
      </div>
    </div>
  )
