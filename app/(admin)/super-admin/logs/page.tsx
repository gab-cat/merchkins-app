        ...
        <CardContent>
          <div className="mb-4 flex items-center gap-2">
            ...
            <select
              ...
              value={isArchived === undefined ? '' : isArchived ? '1' : '0'}
              onChange={(e) => setIsArchived(e.target.value === '' ? undefined : e.target.value === '1')}
            >
              ...
              {filtered.map((l: Log) => (
                <div key={l._id} className="grid grid-cols-12 items-center px-3 py-2 hover:bg-secondary">
                  ...
                  <div className="col-span-2 text-right">
                    {l.isArchived ? (
                      <Button size="sm" variant="outline" onClick={() => handleRestore(l._id)}>
                        Restore
                      </Button>
                    ) : (
                      <Button size="sm" variant="outline" onClick={() => handleArchive(l._id)}>
                        Archive
                      </Button>
                    )}
                  </div>
