        ...
        <CardContent className="grid gap-4 md:grid-cols-2">
          <div>
            ...
            <div className="flex gap-2">
              ...
              <Button variant="secondary" onClick={() => handleUpdate({ name: (document.getElementById('name') as HTMLInputElement).value })}>Save</Button>
            </div>
          </div>
          <div>
            <label className="mb-1 block text-sm font-medium" htmlFor="description">Description</label>
            <div className="flex gap-2">
              <Input id="description" defaultValue={category.description || ''} onBlur={(e) => handleUpdate({ description: e.target.value || undefined })} />
              <Button variant="secondary" onClick={() => handleUpdate({ description: (document.getElementById('description') as HTMLInputElement).value || undefined })}>Save</Button>
            </div>
          </div>
           <div>
            ...
            <div className="flex gap-2">
              ...
              <Button variant="secondary" onClick={() => handleUpdate({ slug: (document.getElementById('slug') as HTMLInputElement).value })}>Save</Button>
            </div>
          </div>
          <div>
      ...
      <Card>
        ...
        <CardContent className="grid gap-4 md:grid-cols-2">
          ...
          <div>
            ...
            <div className="flex gap-2">
              <Input id="displayOrder" type="number" defaultValue={category.displayOrder} onBlur={(e) => handleUpdate({ displayOrder: Number(e.target.value) })} />
              <Button variant="secondary" onClick={() => handleUpdate({ displayOrder: Number((document.getElementById('displayOrder') as HTMLInputElement).value) })}>Save</Button>
            </div>
          </div>
        </CardContent>
      </Card>
