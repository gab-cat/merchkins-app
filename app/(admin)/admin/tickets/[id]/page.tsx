          ...
          <DialogContent>
            ...
            <div className="space-y-3">
              ...
              <div className="flex justify-end gap-2">
                <Button variant="secondary" onClick={() => setIsCommentOpen(false)} disabled={busy}>
                  Cancel
                </Button>
        ...
        <div className="md:col-span-2 space-y-4">
          ...
          <Card className="h-[60vh]">
            ...
            <CardContent className="h-[calc(60vh-5rem)] space-y-3 overflow-y-auto">
              ...
              {list.length === 0 && <div className="text-sm text-muted-foreground">No updates yet.</div>}
            </CardContent>
          </Card>
        </div>
        <div className="space-y-4">
          <Card>
            ...
            <CardContent className="space-y-2 text-sm">
              ...
              <div className="flex items-center justify-between">
                <span>Creator</span>
                <span>{ticket.creatorInfo?.email}</span>
              </div>
              <div className="flex items-center justify-between">
                <span>Assignee</span>
                <span>{ticket.assigneeInfo?.email || 'Unassigned'}</span>
              </div>
              <div className="flex items-center justify-between">
                <span>Updated</span>
              ...
              {ticket.organizationId ? (
                <div className="pt-2">
                  ...
                  <Select value={String(ticket.assignedToId || '')} onValueChange={handleAssign} disabled={eligibleAssignees.length === 0}>
