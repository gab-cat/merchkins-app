...
export default function AdminProductsPage () {
  ...
  const [sortBy, setSortBy] = useState<'newest' | 'oldest' | 'rating' | 'price_low' | 'price_high' | 'popular' | 'orders' | 'views'>('newest')
  ...
  const {
    ...
    loadMore,
    reset,
  } = useOffsetPagination<any, any>({
    query: api.products.queries.index.getProducts,
    baseArgs,
    limit: 25,
    selectItems: (res: any) => res.products || [],
    ...
    <div>
      <div className="mb-6 flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
        ...
        <div className="flex items-center gap-2">
          ...
          <select className="h-9 rounded-md border bg-background px-3 text-sm" value={sortBy} onChange={(e) => setSortBy(e.target.value as typeof sortBy)}>
