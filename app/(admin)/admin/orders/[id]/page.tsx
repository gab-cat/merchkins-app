  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-semibold">{order.orderNumber ? `Order #${order.orderNumber}` : 'Order'}</h1>
          ...
          <div className="flex flex-wrap items-center gap-2">
            ...
            {paymentOptions.map((p) => (
              <Button
                key={p}
                size="sm"
                variant={order.paymentStatus === p ? 'secondary' : 'outline'}
                disabled={updating}
          ...
          <div className="rounded-lg border p-4">
            ...
            <div className="mt-2">
              <ReceivePaymentDialog
                ...
                onCreated={() => {
                  /* rely on Convex live query to refresh */
                }}
              />
            </div>
          </div>
