        ...
        <div className="max-w-7xl mx-auto grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
            ...
            <ul className="space-y-2 text-sm opacity-85">
              <li>
                <Link
                  ...
                  className="inline-flex items-center gap-2 hover:opacity-80 hover:font-bold hover:underline transition-all duration-200"
                >
              ...
              <li>
                <Link
                  href={orgSlug ? `/o/${orgSlug}/c/apparel` : '/c/apparel'}
                  className="hover:opacity-80 hover:font-bold hover:underline transition-all duration-200"
                >
                  Apparel
                </Link>
              </li>
              <li>
                <Link
                  href={orgSlug ? `/o/${orgSlug}/c/accessories` : '/c/accessories'}
                  className="hover:opacity-80 hover:font-bold hover:underline transition-all duration-200"
                >
                  Accessories
                </Link>
          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-2 text-sm opacity-85">
              <li>
                <Link
                  href={orgSlug ? `/o/${orgSlug}/chats` : '/chats'}
                  className="inline-flex items-center gap-2 hover:opacity-80 hover:font-bold hover:underline transition-all duration-200"
                >
          ...
          <div className="space-y-3">
            ...
            >
              <Input name="email" type="email" placeholder="Email address" aria-label="Email address" className="h-8 flex-1 text-sm" required />
              <Button
                type="submit"
                size="sm"
                className="h-8 px-3 text-sm bg-gray-100 text-gray-800 hover:bg-gray-300 hover:text-gray-900 transition-all duration-200"
              >
                Subscribe
              </Button>
            </form>
            <p className="text-xs opacity-70 leading-relaxed">
              ...
              <Link href="#privacy" className="underline hover:opacity-80 hover:font-bold hover:underline transition-all duration-200">
                Privacy Policy
              </Link>
              .
            </p>
      ...
      <div className="w-full px-4 py-3">
        <div className="max-w-7xl mx-auto flex items-center justify-between gap-3 text-xs opacity-80">
          ...
          <div className="flex items-center gap-3">
            <Link href="#terms" className="hover:opacity-80 hover:font-bold hover:underline transition-all duration-200">
              Terms
            </Link>
            <span aria-hidden>•</span>
            <Link href="#privacy" className="hover:opacity-80 hover:font-bold hover:underline transition-all duration-200">
              Privacy
            </Link>
          </div>
        </div>
