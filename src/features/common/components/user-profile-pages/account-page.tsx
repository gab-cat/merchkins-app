      ...
      <SettingsList>
        ...
        >
          <div className="relative max-w-sm">
            ...
            <Input id="phone" value={phone} onChange={(e) => setPhone(e.target.value)} placeholder="Enter phone number" className="pl-9 h-9" />
          </div>
        </SettingsRow>
        ...
        <SettingsRow label={<span>Notifications</span>}>
          <div className="space-y-3">
            <label className="flex items-center gap-3 text-sm cursor-pointer hover:text-primary transition-colors">
              <input type="checkbox" className="h-4 w-4 rounded" checked={prefEmail} onChange={(e) => setPrefEmail(e.target.checked)} />
              Email notifications
            </label>
            <label className="flex items-center gap-3 text-sm cursor-pointer hover:text-primary transition-colors">
              <input type="checkbox" className="h-4 w-4 rounded" checked={prefPush} onChange={(e) => setPrefPush(e.target.checked)} />
              Push notifications
            </label>
            <label className="flex items-center gap-3 text-sm cursor-pointer hover:text-primary transition-colors">
              <input type="checkbox" className="h-4 w-4 rounded" checked={prefOrderUpdates} onChange={(e) => setPrefOrderUpdates(e.target.checked)} />
              Order updates
            </label>
            <label className="flex items-center gap-3 text-sm cursor-pointer hover:text-primary transition-colors">
              <input type="checkbox" className="h-4 w-4 rounded" checked={prefPromotions} onChange={(e) => setPrefPromotions(e.target.checked)} />
              Promotional emails
            </label>
          </div>
        </SettingsRow>
        ...
        >
          <div className="space-y-3">
            ...
            <label className="flex items-center gap-3 text-sm cursor-pointer hover:text-primary transition-colors">
              <input type="checkbox" className="h-4 w-4 rounded" checked={showActivity} onChange={(e) => setShowActivity(e.target.checked)} />
