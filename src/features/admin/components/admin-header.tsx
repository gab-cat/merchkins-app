    ...
    >
      ...
      <div className="container mx-auto flex h-12 items-center gap-4 px-4">
        <div className="flex items-center gap-3">
          ...
          <Link href={pathname?.startsWith('/super-admin') ? '/super-admin' : '/admin'} className="flex items-center gap-2 hover:scale-105 transition-transform duration-200">
        ...
        <form onSubmit={onSearch} role="search" className="ml-4 hidden flex-1 items-center gap-2 md:flex">
          ...
          <Button type="submit" variant="secondary" size="sm" className="h-8 px-4 text-sm hover:scale-105 transition-all duration-200">Search</Button>
        </form>
        ...
        <div className="ml-auto flex items-center gap-2">
          ...
          <SignedOut>
            <Link href="/sign-in">
              <Button variant="ghost" size="sm" className="h-8 px-4 text-sm hover:scale-105 transition-all duration-200">Sign in</Button>
            </Link>
          </SignedOut>
          <SignedIn>
            <UserButton
