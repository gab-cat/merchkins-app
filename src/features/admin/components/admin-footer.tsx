  ...
  return (
    <footer data-testid="admin-footer" className="border-t" style={{ backgroundColor: 'var(--footer-bg)', color: 'var(--footer-fg)' }}>
      <div className="container mx-auto grid gap-3 px-3 py-6 sm:grid-cols-2 lg:grid-cols-4">
        <div>
          <div className="text-xs uppercase mb-1" style={{ color: 'var(--footer-fg)', opacity: 0.8 }}>
            {areaLabel}
          </div>
        ...
        <div>
          ...
          <ul className="space-y-1 text-sm" style={{ color: 'var(--footer-fg)', opacity: 0.85 }}>
            <li>
              <Link href={withOrg('/admin/overview')}>Overview</Link>
            </li>
            <li>
              <Link href={withOrg('/admin/analytics')}>Analytics</Link>
            </li>
          </ul>
        </div>
        <div>
          ...
          <ul className="space-y-1 text-sm" style={{ color: 'var(--footer-fg)', opacity: 0.85 }}>
            <li>
              <Link href={withOrg('/admin/org-members')}>Members</Link>
            </li>
            <li>
              <Link href={withOrg('/admin/org-settings')}>Settings</Link>
            </li>
          </ul>
        </div>
