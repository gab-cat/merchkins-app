        ...
        <div className="container mx-auto px-4 sm:px-6 py-8">
          <div className="grid gap-6">
            {new Array(2).fill(null).map((_, i) => (
              <Card key={`s-${i}`} className="animate-pulse rounded-2xl border shadow-md">
      ...
      <div className="container mx-auto px-4 sm:px-6 py-8 relative z-10">
        ...
        <div className="grid gap-8 lg:grid-cols-3">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <BlurFade delay={0.2}>
              <Card className="rounded-3xl border overflow-hidden">
                <div className="relative pb-5 px-5 bg-white border-b">
          ...
          <div className="space-y-6">
            <BlurFade delay={0.4}>
              <Card className="sticky top-24 rounded-3xl border overflow-hidden">
                {/* Header */}
                <div className="relative pb-6 px-6 border-b">
