  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-md bg-white text-black border-none">
        <DialogHeader className="space-y-0 pb-4">
          <div className="relative -mx-6 -mt-6 mb-4">
            ...
            <div className="absolute -bottom-4 left-1/2 transform -translate-x-1/2">
              <motion.div
                {...fadeInUp}
                className="flex size-22 items-center justify-center rounded-full bg-white border-4 border-white shadow-lg"
              >
        ...
        <motion.div
          {...fadeInUp}
          className="space-y-2 py-2 mx-auto"
        >
        ...
        {organizationSlug && (
          <div className="flex justify-center">
            <Button variant="link" size="sm" asChild>
              <Link
                href={`/(storefront)/o/${organizationSlug}`}
