  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between gap-4">
        ...
        <Link className="text-sm text-primary hover:text-primary/80 font-semibold hover:underline transition-all duration-200 whitespace-nowrap" href="/organizations">
          View all →
        </Link>
      </div>
      <motion.div
          ...
          : organizations.map((org, index) => {
              return (
                ...
                >
                  ...
                  >
                    <Card
                      className="flex h-full flex-col overflow-hidden rounded-xl border bg-card shadow-sm py-0 transition-all duration-300 hover:-translate-y-1 hover:shadow-xl hover:border-primary/30"
                    >
                    ...
                    <div className="relative h-24 w-full overflow-hidden">
                      ...
                      <div className="absolute bottom-2 left-2 flex items-center gap-2 z-10">
                        ...
                        <div className="min-w-0">
                          ...
                          <Badge variant="secondary" className="mt-0.5 text-[10px] px-1.5 py-0.5 font-semibold bg-white text-primary border-transparent shadow-sm">
