...
export function ProductCard({
  ...
  return (
    <Link href={href} aria-label={`View ${title}`} className={`group block h-full ${className}`} data-testid="product-card" prefetch>
      <motion.div variants={fadeInUp} initial="initial" animate="animate">
        <Card className="flex h-full flex-col hover:border-primary/50 hover:shadow-primary/20 overflow-hidden rounded-xl border bg-card shadow-sm py-0 transition-all duration-300 hover:-translate-y-1 hover:shadow-xl">
