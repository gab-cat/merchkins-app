    ...
    >
      ...
      >
        ...
        <div className="relative h-32 w-32">
          {/* Outer glow ring */}
          <div 
            className="absolute inset-0 animate-ping rounded-full bg-primary/20 opacity-20" 
          ...
          <div className="relative flex h-full w-full items-center justify-center rounded-full bg-gradient-to-br from-primary/10 to-primary/20 shadow-inner">
            ...
            <ShoppingBag 
              className="h-16 w-16 animate-bounce text-primary drop-shadow-lg" 
            ...
            >
              <Package 
                className="absolute -right-3 top-2 h-8 w-8 text-primary/70 drop-shadow-md" 
              />
            </div>
            ...
            >
              <Package 
                className="absolute -left-3 bottom-2 h-8 w-8 text-primary/70 drop-shadow-md" 
              />
            </div>
        ...
        <div className="flex flex-col items-center gap-4">
          <h1 
            className="font-genty !text-primary text-5xl font-bold tracking-wide"
          >
            Merchkins
          </h1>
