/**
 * Business information constants for Xendit verification requirements
 * These values must be displayed prominently across the application
 */

export const BUSINESS_NAME = 'MERCHKINS INFORMATION TECHNOLOGY SOLUTIONS';
